...
## v4.8.4 — anuncios temporales
- Mantiene Piper High y la gracia de reconexión de host de v4.8.3.
- Los banners/anuncios superiores temporales se ocultan automáticamente después de 5 segundos.
- Los paneles informativos persistentes (por ejemplo, “Posibles BINGOS detectados”) no se ocultan.
