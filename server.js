...
io.on("connection",socket=>{
  socket.on("createSession",async({hostName,config,origin},cb)=>{
    ...
    registerHost(s,socket,hostName||"Host","primary");prewarmSpeech(hostName||"Host");
  ...
  socket.on("joinCohost",({hostCode,name},cb)=>{
    ...
    registerHost(s,socket,name||"Segundo host","secondary");prewarmSpeech(name||"Segundo host");
