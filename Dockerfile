...
RUN curl -fsSL https://github.com/rhasspy/piper/releases/download/2023.11.14-2/piper_linux_x86_64.tar.gz -o /tmp/piper.tar.gz \
    ...
    && curl -fL https://huggingface.co/rhasspy/piper-voices/resolve/main/es/es_MX/ald/x_low/es_MX-ald-x_low.onnx?download=true -o /opt/piper/voice/es_MX-ald-x_low.onnx \
    && curl -fL https://huggingface.co/rhasspy/piper-voices/resolve/main/es/es_MX/ald/x_low/es_MX-ald-x_low.onnx.json?download=true -o /opt/piper/voice/es_MX-ald-x_low.onnx.json
...
ENV PIPER_MODEL=/opt/piper/voice/es_MX-ald-x_low.onnx
